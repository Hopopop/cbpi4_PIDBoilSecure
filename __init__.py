...
@parameters([Property.Number(label = "P", configurable = True, description="P Value of PID"),
             ...
             Property.Sensor(label="WeightSensor", description="WeightSensor hx711-loadcell"),
             Property.Number(label="MinimumWeight", configurable=True, description="Minimum weight to immerse the Heater. Below, heater should switched off.Default 10")])

class PIDBoilSecure(CBPiKettleLogic):
...
def setup(cbpi):
    ...
    cbpi.plugin.register("PIDBoilSecure", PIDBoilSecure)